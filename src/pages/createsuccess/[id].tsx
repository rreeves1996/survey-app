  ...
  return (
    <div className="card mt-2 h-fit w-full shadow-xl lg:w-96">
      <div className="card-body rounded-md bg-slate-800 pb-4">
        ...
        <p className="mb-3">
          Here are the links to your survey and results page. Save these links,
          as you will <strong className="underline">not</strong> be able to
          recover them once you have left this page!
        </p>
